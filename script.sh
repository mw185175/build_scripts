...
# Local manifests
git clone https://github.com/mw185175/local_manifests -b Cherish-OS-shusky --depth=1 .repo/local_manifests
echo "============================"
...
# Export
export BUILD_USERNAME="GamerBoy1234294 • CherishingTheWorld"
