...
# repo init manifest
repo init -u https://github.com/ProjectBlaze/manifest.git -b 15 --git-lfs --depth=1
echo "====================="
echo "= Repo init success ="
echo "====================="

# Local manifests
git clone https://github.com/Trijal08/local_manifests -b ProjectBlaze-15-shusky --depth=1 .repo/local_manifests
echo "============================"
