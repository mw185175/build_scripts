...
# repo init manifest
repo init -u https://github.com/VoltageOS/manifest.git -b 14 --git-lfs -b 14.0 --git-lfs --depth=1
echo "====================="
echo "= Repo init success ="
echo "====================="

# Local manifests
git clone https://github.com/mw185175/local_manifests -b VoltageOS-14-shusky --depth=1 .repo/local_manifests
echo "============================"
