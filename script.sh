...
# repo init manifest
repo init -u https://github.com/SomethingOS/manifest -b uvite --depth=1 --git-lfs
...
# Local manifests
git clone https://github.com/mw185175/local_manifests.git -b SomethingOS-shusky --depth=1 .repo/local_manifests
echo "============================"
