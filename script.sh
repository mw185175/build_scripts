...
# Local manifests
git clone https://github.com/Trijal08/local_manifests -b BananaDroid-shusky --depth=1 .repo/local_manifests
echo "============================"
...
# Export
export BUILD_USERNAME="GamerBoy1234294 • BananasInAndroid"
